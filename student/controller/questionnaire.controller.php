...
if($received_data->action == 'showScore'){
    ...
    $getQuestionnaireTitle = "SELECT qstnnr_title FROM tbl_questionnaire WHERE qstnnr_id=:qstnnr_id";
    $getQuestionnaireTitle = DB::query($getQuestionnaireTitle, array('qstnnr_id'=>$data['qstnnr_id']))[0]['qstnnr_title'];
